...
alert("please log in")
 ...
 if(checkComment(commentInput.value)){
  ...
  fetch("https://cloudcomputingproject-m1k1.onrender.com/articles/"+id+"/comment", options).then((res) => {
if(res.status == 200){
  location.reload()
}
  })
...
fetch("https://cloudcomputingproject-m1k1.onrender.com/articles/" + id, options).then((res) => res.json()).then((data) => {
...
console.log(data1)
fetch("https://cloudcomputingproject-m1k1.onrender.com/articles/" + id + "/comment", options).then((res) => res.json()).then((data) => {
  console.log(data)
