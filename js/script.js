...
admin.addEventListener("click", (e) => {
  e.preventDefault()
  fetch("https://cloudcomputingproject-m1k1.onrender.com/articles", {
    method: "POST",
    headers: {
...
fetch("https://cloudcomputingproject-m1k1.onrender.com/articles", options).then((res)=> res.json()).then((articles)=> {
...
btopic.innerText = "Mental Health Insights"
...
ion.addEventListener("click",()=>{
  ...
  fetch("https://cloudcomputingproject-m1k1.onrender.com/articles/"+blogId+"/likes", options).then((res)=> res.json()).then((articles)=> { 
...
sendMessage.addEventListener("submit",(e)=>{
  ...
  return false;
    ...
    fetch("https://cloudcomputingproject-m1k1.onrender.com/messages", options).then((res)=> {
      loader.close()
    if(res.status == 200){
      msgSent.showModal()
    }
