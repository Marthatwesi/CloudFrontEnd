...
fetch("https://cloudcomputingproject-m1k1.onrender.com/articles").then((res) => {
  return res.json()
}).then(data => {
  let n = 1
...
//loading the content in the edit dialog
    btn1.addEventListener("click", () => {
      ...
      fetch("https://cloudcomputingproject-m1k1.onrender.com/articles/" + spanid.innerText).then((res) => {
        return res.json()
      }).then((data) => {
        console.log(data)
    ...
    btn2.addEventListener("click", () => {
      ...
      fetch("https://cloudcomputingproject-m1k1.onrender.com/articles/" + index.innerText, options).then((res) => {
        if (res.status == 200) {
          location.reload()
        }
      })
...
fetch("https://cloudcomputingproject-m1k1.onrender.com/articles/"+sessionStorage.getItem("id"), options).then((res) => {
  loader.close()
if(res.status == 200){
...
articleDialog.addEventListener("submit", (e) => {
  ...
  if (checkTitle(articleTitle.value) && checkImage(articleImage.value)) {
    ...
    fetch("https://cloudcomputingproject-m1k1.onrender.com/articles", options).then((res) => {
      loader.close()
      if (res.status == 200) {
        alertMess.showModal()
        // location.reload()
